  ...
  return (
    <div className="min-h-screen bg-parchment">
      ...
      <div className="flex bg-stone-ink px-4 pb-3 gap-2">
        <button
          onClick={() => setTab('hunt')}
          className={`flex-1 py-2 rounded-xl text-sm font-bold font-serif transition-colors ${tab === 'hunt'
        ...
        <button
          ...
          className={`flex-1 py-2 rounded-xl text-sm font-bold font-serif transition-colors ${tab === 'leaderboard'
              ? 'bg-amber-400 text-amber-900'
              : 'bg-amber-900/30 text-amber-200'
            }`}
        >
        ...
        <>
          ...
          <div className="px-4 py-8 text-center">
            <p className="text-xs text-stone-400 font-serif italic">
              13 ancient obelisks · Rome, Italy
            </p>
          </div>
        </>
      )}
